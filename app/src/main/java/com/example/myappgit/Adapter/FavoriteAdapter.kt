    ...
    import com.example.myappgit.ui.ReviewAdapter

    class FavoriteAdapter :
        ListAdapter<FavoriteUser, FavoriteAdapter.FavoriteViewHolder>(DIFF_CALLBACK) {
        private lateinit var onItemClickListener: FavoriteAdapter.OnItemClickListener
        interface OnItemClickListener {
            fun onItemClicked(userActivity: FavoriteUser)
        }
        fun setOnItemClickListener(onItemClickListener:  FavoriteAdapter.OnItemClickListener) {
